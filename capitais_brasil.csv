...
CAPITALS = [
    Place("rio_branco", "Rio Branco", "Rio Branco", "AC", "Norte", -9.97499, -67.8243),
    Place("maceio", "Maceió", "Maceió", "AL", "Nordeste", -9.66599, -35.735),
    Place("macapa", "Macapá", "Macapá", "AP", "Norte", 0.03493, -51.0694),
    Place("manaus", "Manaus", "Manaus", "AM", "Norte", -3.119, -60.0217),
    Place("salvador", "Salvador", "Salvador", "BA", "Nordeste", -12.9777, -38.5016),
    Place("fortaleza", "Fortaleza", "Fortaleza", "CE", "Nordeste", -3.7319, -38.5267),
    Place("brasilia", "Brasília", "Brasília", "DF", "Centro-Oeste", -15.7939, -47.8828),
    Place("vitoria", "Vitória", "Vitória", "ES", "Sudeste", -20.3155, -40.3128),
    Place("goiania", "Goiânia", "Goiânia", "GO", "Centro-Oeste", -16.6869, -49.2648),
    Place("sao_luis", "São Luís", "São Luís", "MA", "Nordeste", -2.5307, -44.3068),
    Place("cuiaba", "Cuiabá", "Cuiabá", "MT", "Centro-Oeste", -15.6014, -56.0979),
    Place("campo_grande", "Campo Grande", "Campo Grande", "MS", "Centro-Oeste", -20.4697, -54.6201),
    Place("belo_horizonte", "Belo Horizonte", "Belo Horizonte", "MG", "Sudeste", -19.9167, -43.9345),
    Place("belem", "Belém", "Belém", "PA", "Norte", -1.4558, -48.5044),
    Place("joao_pessoa", "João Pessoa", "João Pessoa", "PB", "Nordeste", -7.1195, -34.845),
    Place("curitiba", "Curitiba", "Curitiba", "PR", "Sul", -25.4284, -49.2733),
    Place("recife", "Recife", "Recife", "PE", "Nordeste", -8.0476, -34.877),
    Place("teresina", "Teresina", "Teresina", "PI", "Nordeste", -5.0892, -42.8016),
    Place("rio_de_janeiro", "Rio de Janeiro", "Rio de Janeiro", "RJ", "Sudeste", -22.9068, -43.1729),
    Place("natal", "Natal", "Natal", "RN", "Nordeste", -5.7793, -35.2009),
    Place("porto_alegre", "Porto Alegre", "Porto Alegre", "RS", "Sul", -30.0346, -51.2177),
    Place("porto_velho", "Porto Velho", "Porto Velho", "RO", "Norte", -8.7608, -63.8999),
    Place("boa_vista", "Boa Vista", "Boa Vista", "RR", "Norte", 2.8235, -60.6758),
    Place("florianopolis", "Florianópolis", "Florianópolis", "SC", "Sul", -27.5949, -48.5482),
    Place("sao_paulo_capital", "São Paulo", "São Paulo", "SP", "Sudeste", -23.5505, -46.6333),
    Place("aracaju", "Aracaju", "Aracaju", "SE", "Nordeste", -10.9472, -37.0731),
    Place("palmas", "Palmas", "Palmas", "TO", "Norte", -10.184, -48.3336),
]
...
def distance_matrix(places: list[Place]) -> pd.DataFrame:
    rows = []
...
with tab_reference:
    ...
    with ref_cols[1]:
        ...
        st.dataframe(
            pd.DataFrame(nearest_capital_rows(CLUBS, CAPITALS)),
            width="stretch",
            hide_index=True,
        )

    with st.expander("Matriz de distâncias entre clubes"):
        st.dataframe(distance_matrix(CLUBS), width="stretch", hide_index=True)
...
Considere um grafo ponderado \(G=(V,E)\), em que cada vértice \(i \in V\)
representa um clube e cada aresta \((i,j)\) representa o deslocamento entre
duas cidades-sede. O peso \(d_{ij}\) é a distância geodésica aproximada entre
os clubes \(i\) e \(j\).
...
Se a opção de retorno estiver ativada, adiciona-se:
